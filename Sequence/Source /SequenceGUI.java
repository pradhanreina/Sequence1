...
public class SequenceGUI implements ActionListener
{
     ...
     */
    public SequenceGUI(String title)
    {
        // set up frame
    ...
    public static void main(String[] args)
    {
       ...
       //SequenceGUI gui = new SequenceGUI("demo - general");
        //SequenceGUI gui4 = new SequenceGUI("demo - 2");
       //SequenceGUI gui1 = new SequenceGUI("demo - 3");
       //SequenceGUI gui2 = new SequenceGUI("demo - 4");
       // SequenceGUI gui3 = new SequenceGUI("demo - 5");
         SequenceGUI gui5 = new SequenceGUI("demo -6");
